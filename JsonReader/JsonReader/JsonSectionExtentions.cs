...
namespace WonderTools.JsonSectionReader
{
    ...
    {
        public static List<TObject> GetTableAsObjectList<TObject, T1>(this JSection section, Func<T1, TObject> objectFactory)
        {
            var output = section.GetTable(typeof(T1));
            return output.Select(x => objectFactory.Invoke((T1) x.ElementAt(0))).ToList();
        }

        public static List<TObject> GetTableAsObjectList<TObject, T1, T2>(this JSection section, Func<T1, T2, TObject> objectFactory)
        {
        ...
        public static List<TObject> GetTableAsObjectList<TObject, T1, T2, T3>(this JSection section, Func<T1, T2, T3, TObject> objectFactory)
        {
        ...
        public static List<TObject> GetTableAsObjectList<TObject, T1, T2, T3, T4>(this JSection section, 
        ...
        public static List<TObject> GetTableAsObjectList<TObject, T1, T2, T3, T4, T5>(this JSection section,
        ...
        public static List<TObject> GetTableAsObjectList<TObject, T1, T2, T3, T4, T5, T6>(this JSection section,
        ...
        public static List<TObject> GetTableAsObjectList<TObject, T1, T2, T3, T4, T5, T6, T7>(this JSection section,
        ...
        public static List<TObject> GetTableAsObjectList<TObject, T1, T2, T3, T4, T5, T6, T7, T8>(this JSection section,
        ...
        public static List<TObject> GetTableAsObjectList<TObject, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this JSection section,
        ...
        public static List<TObject> GetTableAsObjectList<TObject, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this JSection section,
        ...
        public static List<TObject> GetTableAsObjectList<TObject, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(this JSection section,
        ...
        public static List<TObject> GetTableAsObjectList<TObject, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(this JSection section,
